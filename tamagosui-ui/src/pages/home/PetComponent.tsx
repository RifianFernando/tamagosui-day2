...
import { useMutateCheatPet } from '@/hooks/useMutateCheatPet';
...
export default function PetComponent({ pet }: PetDashboardProps) {
    ...
    const { mutate: mutateCheatPet, isPending: isCheating } =
        useMutateCheatPet();
            ...
            const intervalId = setInterval(() => {
                setDisplayStats((prev) => {
                    ...
                    return {
                        ...
                        happiness: Math.max(
                            0,
                            prev.happiness - happinessLossPerSecond
                        ),
                    };
                });
                ...
                <CardContent className='space-y-4'>
                    ...
                    <div className='space-y-3'>
                        ...
                        <div className='space-y-2'>
                            ...
                            <StatDisplay
                                icon={
                                    <DrumstickIcon className='text-orange-500' />
                                }
                                label='Hunger'
                    ...
                    <div className='grid grid-cols-2 gap-3'>
                        ...
                        <div className='col-span-2'>
                            <ActionButton
                                onClick={() =>
                                    mutateCheatPet({ petId: pet.id })
                                }
                                disabled={isAnyActionPending}
                                isPending={isCheating}
                                label='Cheating (Dev Only)'
                                icon={<BriefcaseIcon />}
                            />
                        </div>
                    </div>
